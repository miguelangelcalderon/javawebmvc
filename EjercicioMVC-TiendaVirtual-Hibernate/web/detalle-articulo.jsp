...
<%
    ...
    {   
        a=aDAO.getById(Integer.parseInt(request.getParameter("id")));
    }else {
        a=(Articulos)request.getAttribute("articulo");
    }
...
<html>
  ...
  <h2>Datos del  producto ${a.nombre}}</h2>
            ...
            <tr>
                <th>Proveedor</th>
                <td>${a.proveedores.nombre}</td>
                
            </tr>
            <tr>
                <th>Novedad</th>
                <td>${a.novedad eq true?"SI":"NO"}</td>
            </tr>
            <tr>
                <th>Oferta</th>
                <td>${a.oferta eq true?"SI":"NO"}</td>
            </tr>
             <tr>
                 <td colspan="2">
                     <a href="Cesta?accion=add&id=${a.idArticulo}">
