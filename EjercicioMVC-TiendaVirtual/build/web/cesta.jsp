    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td><a href="/EjercicioMVC-TiendaVirtual/Cesta?accion=removeOne&id=${actual.key}"><img src="img/restar.png"></a>&nbsp;
                    <a href="/EjercicioMVC-TiendaVirtual/Cesta?accion=addOne&id=${actual.key}"><img src="img/aumentar.png"></a>
                    </td>
                <td>${actual.value.pvp*actual.value.cantidadCarrito} €</td>
                <td><a href="/EjercicioMVC-TiendaVirtual/Cesta?accion=removeItem&id=${actual.key}"><img src="img/eliminar.png"></a></td>
            </tr>
