...
public class Cesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Hashtable<Integer,Articulo> carrito;
        if (sesion.getAttribute("cesta")==null)
        {
           sesion.setAttribute("cesta", new Hashtable<Integer,Articulo>());
        }
        ...
        carrito=(Hashtable<Integer,Articulo>)sesion.getAttribute("cesta");
